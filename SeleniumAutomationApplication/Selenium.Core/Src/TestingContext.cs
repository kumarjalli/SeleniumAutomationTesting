...
namespace Selenium.Core
{
  public class TestingContext
  {
    ...
    public TestingContext(Uri url, Browsers browser, Clopay.TestAutomation.OperatingSystem os)
    {
      Browser = browser;
      BaseUrl = url;
      OS = os;
    ...
    {
      return (this.OS == OperatingSystem.iOS) || (this.OS == OperatingSystem.Andoid);
    }
  }
